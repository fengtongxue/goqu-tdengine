...
// Sets the Using to insert into
func (id *InsertDataset) Using(using interface{}) *InsertDataset {
	return id.copy(id.clauses.SetUsing(exp.ParseIdentifier(using.(string))))
}

// Sets the Tags to insert into
func (id *InsertDataset) Tags(tags ...interface{}) *InsertDataset {
	return id.copy(id.clauses.SetTags(exp.NewColumnListExpression(tags...)))
}
